          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              Container(
                ...
                decoration: BoxDecoration(color: const Color(0xFF3D1500), borderRadius: BorderRadius.circular(4)),
                child: const Text('अहिराणी', style: TextStyle(color: Color(0xFFFF9966), fontSize: 10)),
              ),
              const SizedBox(width: 8),
              Expanded(child: Text(verse['ahirani']!, style: const TextStyle(color: Color(0xFFDDC08A), fontSize: 13, height: 1.5), maxLines: 2, overflow: TextOverflow.ellipsis)),
            ])
          ]),
        ),
      ),
